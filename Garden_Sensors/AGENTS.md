...
2. **Pin Configuration via `platformio.ini`:**
   ...
   - Example:
     ...
     build_flags =
       ...
       -D SOIL_MOISTURE_PROBE_1_AIR_VALUE=3500
       -D SOIL_MOISTURE_PROBE_1_WATER_VALUE=100
         -D SOIL_MOISTURE_PROBE_2_POWER_PIN=20
         -D SOIL_MOISTURE_PROBE_2_AO_PIN=1
       -D SOIL_MOISTURE_PROBE_2_AIR_VALUE=3480
       -D SOIL_MOISTURE_PROBE_2_WATER_VALUE=50
     ```
